...
CREATE TABLE `aligned_rna_short_read` (
  ...
  `five_prime_three_prime_bias` float COMMENT 'The ratio of the 5’ bias and the 3’ bias (5'' bias is the ratio between mean coverage at the 5’ region (first 100bp) and the whole transcript, and 3'' bias is the ratio between mean coverage at the 3’ region (last 100bp) and the whole transcript.)',
